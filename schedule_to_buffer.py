...
("06/02/2026","09:00","LinkedIn",f"A client came to us paying $4,200/year across two separate carriers — one for home, one for auto.\n\nAfter shopping both together across our 10+ personal lines carriers, we placed them with one carrier for $3,100 combined. Same coverage. $1,100 saved.\n\nWe don't earn more by bundling — we just find the best fit. That's what an independent agent does.\n\nWorth a 10-minute conversation? Call {PHONE} or visit {QUOTE}"),
("06/02/2026","12:00","X",f"Captive agents (State Farm, Allstate) show you one rate. We shop 10+ carriers at once. The math tends to favor choice. {QUOTE} | {PHONE}"),
...
("07/27/2026","12:00","X",f"45 years in Michigan. Independent. Working for clients, not carriers. We shop 10+ personal and 20+ commercial carriers. {QUOTE} | {PHONE}"),
("07/28/2026","09:00","LinkedIn",f"What does it actually mean to work with an independent insurance agency?\n\nIt means your agent isn't tied to one carrier's products or pricing. We shop across the market — 10+ personal lines carriers and 20+ commercial — and place your coverage where it fits best.\n\nCaptive agents (State Farm, Allstate, Farmers, etc.) can only offer you their employer's products. Nothing wrong with those products — but you're seeing one option.\n\nWe've been doing this in Michigan since 1981. If you're up for renewal or want a second opinion, call {PHONE}."),
("07/28/2026","12:00","X",f"Captive agent: one carrier, one rate. Independent agent: 10+ carriers, best rate. We've been the latter in Michigan since 1981. {PHONE}"),
